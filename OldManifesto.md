### Old manifesto
I have grown a lot as a musician since I first created this tool.

I do not regret initially rejecting music theory; Forcing myself to understand notes and chords on an intuitive level without it taught me a lot.
And creating this tool was absolutely a good decision.
I actually discovered several techniques, which, to my knowledge, are original, for beginning to train one's ears to hear individual notes.

That being said, my view points have evolved a little bit.
I recognize, now, the usefulness of music theory as a communication tool, and a nice standardized labeling system for ***common*** chords.

I still think that system has major flaws, and I still disagree with its theoretical underpinnings for various reasons, but much like the imperial unit system, sometimes you have to just accept a flawed but popular system in order to gain the benefits of ***sharing*** that system with a great deal of other individuals.

So, to that end, I still stand by what I originally wrote here, I just think it is less representative of my true stance these days, and maybe even a little off-putting to people who might stumble across this page.

As such I have decided to move the old manifesto to a backup page, and write a new shortened motivations section.
